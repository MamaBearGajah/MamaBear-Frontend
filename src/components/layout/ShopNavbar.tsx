              ...
              {state.isAuthenticated ? (
                <>
                  ...
                  <button
                    ...
                    className="inline-flex h-10 flex-1 items-center justify-center gap-1.5 rounded-full bg-red-50 px-4 text-sm font-semibold text-red-500 transition hover:bg-red-100 min-w-[100px]"
                  >
