...
export default function ImageUploader({
  ...
  const uploadDirect = async (file: File): Promise<string> => {
    ...
    if (!data.imageUrl) {
      throw new Error("Backend upload selesai, tetapi imageUrl tidak ditemukan.");
    }
  ...
  return (
    ...
    >
      <div className="border-b border-[#E8E3E8] px-5 py-4">
        ...
        {description && (
          <p className="mt-1 pl-12 text-[12px] text-[#8D6B5B]">{description}</p>
        )}
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[12px] leading-5 text-[#8D6B5B]">
              Atau paste URL gambar langsung (Cloudinary, CDN, dsb.)
            </p>
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="altText">
              Title / Alt Text <span className="text-[#D5557E]">*</span>
            </Label>
            <Input
              id="altText"
