...
export const mockBlogs: BlogList[] = [
  {
    id: "art-1",
    authorId: "author-1",
    title: "10 Natural Ways to Boost Your Milk Supply",
    slug: "10-cara-alami-tingkatkan-asi",
    excerpt:
      "Struggling with low milk supply? Before reaching for supplements, try these evidence-backed natural strategies that real mamas swear by.",
    coverImage:
      "https://images.unsplash.com/photo-1648375975494-30e0629799a4",
    content: `
      <h2>Feed Frequently</h2>
      <p>
        Newborns typically feed 8–12 times in 24 hours.
        The more milk removed from the breast, the more your body produces.
      </p>

      <h2>Stay Hydrated</h2>
      <p>
        Aim for 2–3 liters of water per day to support healthy milk production.
      </p>

      <h2>Rest Matters</h2>
      <p>
        Chronic fatigue can negatively impact breastfeeding.
      </p>
    `,
    status: "published",
    viewCount: 1250,
...

  {
    ...
    slug: "nutrisi-lengkap-ibu-menyusui",
    excerpt:
      "What you eat directly affects the quality and quantity of your breast milk.",
    coverImage:
      "https://images.unsplash.com/photo-1758523419881-a105870bec27",
    content: `
      <h2>Nutrition Matters</h2>
      <p>
        Breastfeeding mothers require additional calories and nutrients.
      </p>
      ...
      <h2>Calcium</h2>
      <p>
        Supports bone health for both mother and baby.
      </p>
    `,
    status: "published",
    viewCount: 890,
